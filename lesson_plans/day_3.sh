...
echo 'espeak -s 120 -p 10 "time to have a break"' | at 16:00
echo 'espeak -s 120 -p 10 "back to work"' | at 16:15
echo 'espeak -s 120 -p 10 "enjoy the rest of your day"' | at 17:00
